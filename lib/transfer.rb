class Transfer
  ...
  def execute_transaction
    if @status == "complete" || @status == "reversed"
      "This transaction has already been processed. If you wish to make another transfer, please initialize a new transaction."
  ...
  def reverse_transfer
    if @status == "complete"
      ...
      "This transaction was never processed."
    end
  end
